import { EShaderStage } from '../CodeGen/constants';
import { EKeyword } from '../Lexer/TokenType';
import { GalaceanDataType, TypeAny } from '../Parser/types';
...
export class BuiltinFunction {
  ...
  static getReturnType(fn: BuiltinFunction, genType?: NonGenericGalaceanType) {
    if (!isGenericType(fn._returnType))
      return fn._returnType as NonGenericGalaceanType;
    return genType;
  }
  ...
  static getFn(
    ...
    | { fun: BuiltinFunction; genType: Exclude<GalaceanDataType, string> }
    | undefined {
    const list = BuiltinFunctionTable.get(ident);
...
BuiltinFunction._createWithScop(
  'dFdx',
  EGenType.GenType,
